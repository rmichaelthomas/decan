...
export const temporalCoreCapabilities = (): CapabilityResult => ({ ok: true, value: { profile: "temporal-core", operations: operations({ validate: "exact", resolve: "partial" }), features: [{ id: "snapshot-temporal-core", support: { resolve: "partial" } }, { id: "explicit-locale-snapshots", support: { resolve: "exact" } }, { id: "explicit-observer-snapshots", support: { resolve: "exact" } }, { id: "live-dynamic-observers", support: { resolve: "pending" } }, { id: "cron-rrule-adapters", support: { resolve: "unsupported" } }] } });

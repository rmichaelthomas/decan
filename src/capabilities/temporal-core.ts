...
export const temporalCoreCapabilities = (): CapabilityResult => ({ ok: true, value: { profile: "temporal-core", operations: operations({ validate: "exact", resolve: "partial" }), features: [{ id: "snapshot-temporal-core", support: { resolve: "partial" } }, { id: "locale-day-period", support: { resolve: "pending" } }, { id: "dynamic-observers", support: { resolve: "pending" } }, { id: "cron-rrule-adapters", support: { resolve: "unsupported" } }] } });

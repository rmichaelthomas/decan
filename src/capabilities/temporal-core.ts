...
export const durableOccurrenceCapabilities = (): CapabilityResult => ({ ok: true, value: { profile: "durable-occurrences", operations: operations({ validate: "exact", resolve: "partial", materialize: "partial", queryOccurrences: "exact", getOccurrence: "exact" }), features: [{ id: "sqlite-append-only-occurrences", support: { materialize: "partial", queryOccurrences: "exact", getOccurrence: "exact" } }] } });
